...
public class ProductionPageController implements Initializable {
    ...
    @FXML
    private TableColumn<ProductionModel, ?> quantity;
    @FXML
    private TableColumn<ProductionModel, String> status;
    @FXML
    private TableColumn<ProductionModel, Date> startDate;
    @FXML
    private TableView<ProductionModel> productionTable;
    
    private ProductionService ps = new ProductionService();
    ...
    {
        productionId.setCellValueFactory(new PropertyValueFactory<>("productionId"));
        ...
        try {
            ol = FXCollections.observableArrayList(ps.getAllProduction());
